...
public class OrcamentoController : ControllerBase
{
    ...
    /// <summary>
    /// Busca todos os orçamentos (Requer autenticação de admin).
    /// </summary>
    /// <returns>Uma lista de todos os orçamentos no sistema.</returns>
    [HttpGet]
    [Authorize(Roles = "admin")]
    [ProducesResponseType(typeof(IEnumerable<OrcamentoResponseDto>), 200)]
    ...
    /// <summary>
    /// Busca um orçamento específico pelo seu ID (Requer autenticação).
    /// </summary>
    /// <param name="id">O ID do orçamento.</param>
    /// <returns>Os dados detalhados do orçamento.</returns>
    [HttpGet("{id}")]
    [Authorize(Roles = "user,admin")]
    [ProducesResponseType(typeof(OrcamentoFrontInputDto), 200)]
    ...
    /// <summary>
    /// Cria um novo orçamento a partir das seleções do frontend (Requer autenticação).
    /// </summary>
    /// <remarks>
